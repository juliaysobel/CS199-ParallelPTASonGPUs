...
def align_back_to_ca_s(filename,CA_s):
    ...
    #for names in [p[1] for p in Proteins]:
    #ifCA.append([x=='CA' for x in names])

#   P_CAs = [v for (cond,v) in zip(ifCA,P)]
#   print len(P_CAs)


if __name__ == "__main__":
    #Load Proteins and PDBID
